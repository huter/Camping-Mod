...
public class ModConfig {
	...
	{ 
		 ...
		 try
		 {
			 ...
			 Items.ITEM_BOOK_GUIDE_ID = config.getItem(Items.ITEM_BOOK_GUIDE_GAME_NAME, Items.ITEM_BOOK_GUIDE_ID_DEV).getInt(Items.ITEM_BOOK_GUIDE_ID_DEV);
			 Items.ITEM_ARMOR_HELM_ID = config.getItem(Items.ITEM_ARMOR_HELM_GAME_NAME, Items.ITEM_ARMOR_HELM_ID_DEV).getInt(Items.ITEM_ARMOR_HELM_ID_DEV);
			 Items.ITEM_ARMOR_CHEST_ID = config.getItem(Items.ITEM_ARMOR_CHEST_GAME_NAME, Items.ITEM_ARMOR_CHEST_ID_DEV).getInt(Items.ITEM_ARMOR_CHEST_ID_DEV);
			 Items.ITEM_ARMOR_LEG_ID = config.getItem(Items.ITEM_ARMOR_LEG_GAME_NAME, Items.ITEM_ARMOR_LEG_ID_DEV).getInt(Items.ITEM_ARMOR_LEG_ID_DEV);
			 Items.ITEM_ARMOR_BOOT_ID = config.getItem(Items.ITEM_ARMOR_BOOT_GAME_NAME, Items.ITEM_ARMOR_BOOT_ID_DEV).getInt(Items.ITEM_ARMOR_BOOT_ID_DEV);
			 
			 if(Items.ITEM_ARMOR_HELM_ID<4096||Items.ITEM_ARMOR_LEG_ID<4096||Items.ITEM_ARMOR_CHEST_ID<4096||Items.ITEM_ARMOR_BOOT_ID<4096||Items.ITEM_TENT_PARTS_ID<4096||Items.ITEM_MARSH_ID<4096||Items.ITEM_FOOD_ID<4096||Items.ITEM_TOOL_CAMP_ID<4096||Items.ITEM_TOOL_CAMP2_ID<4096||Items.ITEM_TOOL_BACK_ID<4096||Items.ITEM_RADISH_SEED_ID<4096||Items.ITEM_BOOK_GUIDE_ID<4096)
			 {
				 ...
				 Items.ITEM_ARMOR_HELM_ID = Items.ITEM_ARMOR_HELM_ID_DEV;		
				 Items.ITEM_ARMOR_CHEST_ID = Items.ITEM_ARMOR_CHEST_ID_DEV;		
				 Items.ITEM_ARMOR_LEG_ID = Items.ITEM_ARMOR_LEG_ID_DEV;		
				 Items.ITEM_ARMOR_BOOT_ID = Items.ITEM_ARMOR_BOOT_ID_DEV;		
			 }
			 ...
			 Config.GENERAL_XML_INTERACTION = config.get(Config.CATEGORY_GENERAL,  Config.GENERAL_XML_INTERACTION_MESSAGE, Config.GENERAL_XML_INTERACTION_DEV).getBoolean(Config.GENERAL_XML_INTERACTION_DEV);
			 ...
			 Config.GENERAL_CAMPING_RENDERING_DISABLED = config.get(Config.CATEGORY_GENERAL,  Config.GENERAL_CAMPING_RENDERING_DISABLED_MESSAGE, Config.GENERAL_CAMPING_RENDERING_DISABLED_DEV).getBoolean(Config.GENERAL_CAMPING_RENDERING_DISABLED_DEV);
			 Config.GENERAL_GET_GUIDES = config.get(Config.CATEGORY_GENERAL,  Config.GENERAL_GET_GUIDES_MESSAGE, Config.GENERAL_GET_GUIDES_DEV).getBoolean(Config.GENERAL_GET_GUIDES_DEV);
