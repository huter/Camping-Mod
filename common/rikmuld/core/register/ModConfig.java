...
public class ModConfig {
	...
	{ 
		 ...
		 try
		 {
			 ...
			 Config.TOOL_CAMPTOOL_MAX_DURABILATY = config.get(Config.CATEGORY_TOOL,  Config.TOOL_CAMPTOOL_MAX_DURABILATY_MESSAGE, Config.TOOL_CAMPTOOL_MAX_DURABILATY_DEV).getInt(Config.TOOL_CAMPTOOL_MAX_DURABILATY_DEV);
			 ...
			 CampingMod.proxy.setKeyBinding(KeyHelper.keyCraft, config.get(Config.CATEGORY_GENERAL,  Config.GENERAL_KEYBIND_CRAFT_MESSAGE, Config.GENERAL_KEYBIND_CRAFT_DEV).getInt(Config.GENERAL_KEYBIND_CRAFT_DEV));
			 CampingMod.proxy.setKeyBinding(KeyHelper.keyBackpack, config.get(Config.CATEGORY_GENERAL,  Config.GENERAL_KEYBIND_BACKPACK_MESSAGE, Config.GENERAL_KEYBIND_BACKPACK_DEV).getInt(Config.GENERAL_KEYBIND_BACKPACK_DEV));
			 Config.GENERAL_RECIPIE_PEASFULL = config.get(Config.CATEGORY_GENERAL,  Config.GENERAL_RECIPIE_PEASFULL_MESSAGE, Config.GENERAL_RECIPIE_PEASFULL_DEV).getBoolean(Config.GENERAL_RECIPIE_PEASFULL_DEV);
			 Config.GENERAL_CHECK_VERSION = config.get(Config.CATEGORY_GENERAL,  Config.GENERAL_CHECK_VERSION_MESSAGE, Config.GENERAL_CHECK_VERSION_DEV).getBoolean(Config.GENERAL_CHECK_VERSION_DEV);
			 Config.GENERAL_SEPARATED_TENT = config.get(Config.CATEGORY_GENERAL,  Config.GENERAL_SEPARATED_TENT_MESSAGE, Config.GENERAL_SEPARATED_TENT_DEV).getBoolean(Config.GENERAL_SEPARATED_TENT_DEV);
