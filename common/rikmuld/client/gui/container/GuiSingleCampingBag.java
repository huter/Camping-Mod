...
public class GuiSingleCampingBag extends GuiContainer {
   	
    protected int ySize = 166;
    
    InventorySingleCampingBag inventory;
	ItemStack backpack;
	
	public GuiSingleCampingBag(InventoryPlayer par1InventoryPlayer,	InventorySingleCampingBag iInventory, ItemStack back) 
	{
		super(new ContainerSingleCampingBag(par1InventoryPlayer, iInventory, back));
