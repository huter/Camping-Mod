...
public class InventorySingleCampingBag extends InventoryBasic {
	...
	public InventorySingleCampingBag(EntityPlayer player, ItemStack is) 
	{
		super("", false, (is.getItemDamage()+1)*9+1);
